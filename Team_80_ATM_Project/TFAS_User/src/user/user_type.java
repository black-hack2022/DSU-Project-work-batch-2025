...
private String pin="",tag="";
    /**
     * Creates new form user_type
     */
    public user_type(String p,String tag) {
        this.pin=p;
        this.tag=tag;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String epin=jPasswordField1.getText().toString();
        if(pin.equals(epin))
        {
        new fingerReader(tag).setVisible(true);
