...
public class DBQuery {
    ...
    String q="select * from login where acNo='"+user+"' and password='"+pass+"'";
    rs=st.executeQuery(q);
    while(rs.next())
    {
     dbUser=rs.getString("acNo");
   ...
   //  utype=rs.getString("utype");
    ...
    public int register_user(String fn,String ln,String bankname,String ac,String d,String m,String y,String sex,String a1,String city,String pin,String mob,String email,String aadhaar1) throws ClassNotFoundException, SQLException
    {
        try{
    int i=0,j=0;
   int[] ii = new int[2] ;
...
//    int acc=Integer.parseInt(ac);
    ...
    String q="insert into user_details values('"+fn+"','"+ln+"','"+bankname+"','"+ac+"','"+dob+"','"+sex+"','"+a1+"','"+city+"','"+pin+"','"+mob+"','"+email+"','"+aadhaar1+"','"+pincode+"')";
  ...
  // ii[1]=pincode;
   return j;
    ...
    public int modify_user(String fn,String ln,String ac,String d,String m,String y,String sex,String a1,String city,String pin,String mob,String email) throws ClassNotFoundException, SQLException
    {
    int i=0,j=0;
   ...
   // int acc=Integer.parseInt(ac);
    ...
    String q="update user_details set fname='"+fn+"',lname='"+ln+"',dob='"+dob+"',sex='"+sex+"',add1='"+a1+"',city='"+city+"',pin='"+pin+"',mobile='"+mob+"',email='"+email+"' where acNo='"+ac+"'";
   ...
   j=st.executeUpdate(q);
    ...
    Connection con=db.getConnection();
    st=con.createStatement();
    String d="select * from user_details where acNo='"+uname+"'";
    rs=st.executeQuery(d);
    while(rs.next()){
    ss[0]=rs.getString("fname");
    ss[1]=rs.getString("lname");
    ss[2]=rs.getString("acNo")+"";
 ...
 //   ss[12]=rs.getString("rfid");
   ...
   // String q1="delete from login where acNo='"+ac+"'";
    ...
    String q3="delete from transaction where username='"+user+"'";
  ...
  /*  RSA r=new RSA(1024);
    ...
    String q="select password from login where username='"+user+"'";
    rs=st.executeQuery(q);
    while(rs.next()){
    ...
    public int getAc(String user) throws ClassNotFoundException, SQLException{
    String s="";int i=0;
    Connection con=db.getConnection();
    st=con.createStatement();
    
    String q="select acNo from login where username='"+user+"'";
    rs=st.executeQuery(q);
    while(rs.next()){
    i=rs.getInt("acNo");
    }
    return i;
     ...
     public int checkUser(String user) throws ClassNotFoundException, SQLException{
    String s="";int i=0;
    Connection con=db.getConnection();
    st=con.createStatement();
    
    String q="select * from user_details where acNo='"+user+"'";
    rs=st.executeQuery(q);
    if(rs.next()){
    i=1;
    }
    ...
    return i;
        ...
        public int checkUserAC(String ac) throws ClassNotFoundException, SQLException{
    String s="";int i=0;
    Connection con=db.getConnection();
    st=con.createStatement();
   // int acc=Integer.parseInt(ac);
    ...
    return i;
         ...
         public int checkUserRfid(String rfid) throws ClassNotFoundException, SQLException{
    String s="";int i=0;
    Connection con=db.getConnection();
    st=con.createStatement();
    int acc=Integer.parseInt(rfid);
    String q="select * from login where rfid='"+acc+"'";
    rs=st.executeQuery(q);
    if(rs.next()){
    i=1;
    }
    ...
    String q="select balance from balance where username='"+user+"'";
    rs=st.executeQuery(q);
    while(rs.next()){
    ...
    public int update_balance(String ac,String bal) throws ClassNotFoundException, SQLException
    {
    int i=0;
    int oBal=0; 
  //  int acc=Integer.parseInt(ac);
    ...
    String type="user";
    String u1="select * from balance where acNo='"+ac+"'";
   ...
   oBal=rs.getInt("balance");
        ...
        if(oBal==0){
        String u2="insert into balance values('"+ac+"','"+amt+"')";
       i=st.executeUpdate(u2);
        
        }
        else{
   amt=oBal+amt;
    String u="update balance set balance='"+amt+"' where acNo='"+ac+"'";
   ...
   // int ii[]={i,pincode};
    ...
    oBal=rs.getInt("balance");
        ...
        else if(amt<oBal)
        {
          ...
          String qq1="insert into transaction values('"+user+"','"+dat+"','"+tran+"','"+flag+"',"+amt+")";
